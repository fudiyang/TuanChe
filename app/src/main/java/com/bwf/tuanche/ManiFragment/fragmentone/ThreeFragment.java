...
public class ThreeFragment extends BaseFragment {
    ...
    private RelativeLayout rl_hunying;
    private String cityId;

    public void setThreeResultBean(ThreeResultBean threeResultBean,String cityId) {
    ...
    protected void initView(View rootView) {
        rl_hunying = findViewByIdNoCast(R.id.rl_hunying);
        ...
        rl_hunying.setOnClickListener(this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.rl_hunying:
                Bundle bundle=new Bundle();
                bundle.putString("cityId",cityId);
                IntentUtils.openActivity(getContext(), HunyinActivity.class,bundle);
                break;
        }
    }
}
