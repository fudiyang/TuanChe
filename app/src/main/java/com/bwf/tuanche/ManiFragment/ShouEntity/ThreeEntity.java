...
public class ThreeEntity implements Parcelable {
    ...
    public static final Parcelable.Creator<ThreeEntity> CREATOR = new Parcelable.Creator<ThreeEntity>() {
        @Override
        public ThreeEntity createFromParcel(Parcel source) {
            return new ThreeEntity(source);
        }
