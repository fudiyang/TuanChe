...
public class FourEntity implements Parcelable {
    ...
    public static final Parcelable.Creator<FourEntity> CREATOR = new Parcelable.Creator<FourEntity>() {
        @Override
        public FourEntity createFromParcel(Parcel source) {
            return new FourEntity(source);
        }
